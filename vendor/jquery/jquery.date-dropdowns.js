;(function ($, window, document, undefined) {
    ...
    var pluginName = 'dateDropdowns',
        pluginDefaults = {
            ...
            monthLabel: 'الشهر',
            yearLabel: 'السنة',
            monthLongValues: ['جانفي', 'فيفري', 'مارس', 'أفريل', 'ماي', 'جوان', 'جويلية', 'أوت', 'سبتمبر', 'أكوبر', 'نوفمبر', 'ديسمبر'],
            monthShortValues: ['Janv.', 'Févr.', 'Mars', 'Avril', 'Mai', 'Juin', 'Juil.', 'Août', 'Sept.', 'Oct.', 'Nov.', 'Déc.'],
            initialDayMonthYearValues: ['اليوم', 'الشهر', 'السنة'],
            daySuffixValues: ['', '', '', '']
        };
